import { FlatList, Pressable, Text, TouchableOpacity, View, ScrollView, Button } from "react-native";
              ...
              <Pressable className={cn('offer-card', isEven ? 'flex-row-reverse' : 'flex-row')} style={{ backgroundColor: item.color }} android_ripple={{ color: "#fffff22"}}>
                {(pressed) => (
                  ...
                  <View className={cn("offer-card__info", isEven ? 'pl-10' : 'pr-10')}>
                    ...
                    <Image source={images.arrowRight} className="size-10" tintColor='#ffffff' resizeMode="contain"/>
                  </View>
                </Fragment>
              )}
            </Pressable>
            ...
            <View className="flex-between flex-row my-5">
              <View className="flex-start">
                ...
                <TouchableOpacity className="flex-center flex-row gap-x-1 mt-0.5">
                  <Text className="paragrapgh-bold text-dark-100">Pakistan</Text>
